...
func (w *K8sClient) GetDevWsStatus(name, namespace string) (*workspacev1alpha1.WorkspacePhase, error) {
	namespacedName := types.NamespacedName{
		Name:      name,
		Namespace: namespace,
	}

	workspace := &workspacev1alpha1.DevWorkspace{}
...
func (w *K8sClient) WaitDevWsStatus(name, namespace string, expectedStatus workspacev1alpha1.WorkspacePhase) (bool, error) {
	...
	for {
		...
		case <-tick:
			...
			if *currentStatus == workspacev1alpha1.WorkspaceStatusFailed {
